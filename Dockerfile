...
# Directorio origen predeterminado de backup
RUN mkdir -p "$SRC"

# Preservar caché entre contenedores
VOLUME [ "/root" ]
...
RUN apk add --no-cache --virtual .build \
        ...
        libxslt-dev \
        openssl-dev \
    # Dependencias de tiempo de ejecución, basadas en https://bazaar.launchpad.net/~duplicity-team/duplicity/0.8-series/view/head:/requirements.txt
